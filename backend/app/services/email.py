...
class EmailService:
    ...
    @staticmethod
    def send_user_booking_submitted(booking_details: dict):
        """Send notification to user when they submit a booking request."""
        subject = "Booking Request Received - Rudra Stay"
        ...
        <div style="font-family: Arial, sans-serif; max-w-md; margin: 0 auto; color: #4a3b32;">
            ...
            <h2 style="color: #4a3b32;">Booking Request Submitted</h2>
            <p>Dear {booking_details.get('guest_name')},</p>
            <p>Thank you for choosing Rudra Stay! We have received your booking request for the <strong>{booking_details.get('item_name')}</strong> from {booking_details.get('check_in')} to {booking_details.get('check_out')}.</p>
            <p>Our team is currently reviewing your request. <strong>You will be notified shortly</strong> once your booking is confirmed.</p>
            
            <div style="background-color: #fcf9f2; padding: 20px; border-radius: 8px; border: 1px solid #eaddba; margin: 20px 0;">
                <h3 style="margin-top: 0; color: #b58d3d;">Request Summary</h3>
